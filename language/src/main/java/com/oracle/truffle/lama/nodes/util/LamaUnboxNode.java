 ...
 * SOFTWARE.
 */
package com.oracle.truffle.lama.nodes.util;
...
@NodeChild
public abstract class LamaUnboxNode extends LamaExpressionNode {
    ...
    @Specialization
    protected static LamaNull fromFunction(LamaNull value) {
        return value;
    }
