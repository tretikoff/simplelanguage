...
import com.oracle.truffle.lama.nodes.SLUndefinedFunctionRootNode;
...
public final class SLFunction implements TruffleObject {
    ...
    private static final TruffleLogger LOG = TruffleLogger.getLogger(LamaLanguage.ID, SLFunction.class);
    ...
    protected SLFunction(LamaLanguage language, String name) {
