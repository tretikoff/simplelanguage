...
public class SimpleLanguageParser extends Parser {
	...
	public static Map<String, RootCallTarget> parseSL(LamaLanguage language, Source source) {
	...
	public static class BlockContext extends ParserRuleContext {
		...
		public LamaStatementNode result;
		public Token s;
	...
	public final BlockContext block(boolean inLoop) throws RecognitionException {
		...
		try {
			...
			{
			 factory.startBlock();
			                                                  List<LamaStatementNode> body = new ArrayList<>();
			setState(58);
	...
	public final If_statementContext if_statement(boolean inLoop) throws RecognitionException {
		...
		try {
			...
			_localctx.then = _localctx.block = block(inLoop);
			 LamaStatementNode elsePart = null;
			setState(111);
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (_la==T__12) {
	...
	public final FactorContext factor() throws RecognitionException {
		...
		try {
			...
			case IDENTIFIER:
				...
				setState(177);
				_localctx.IDENTIFIER = match(IDENTIFIER);
				 LamaExpressionNode assignmentName = factory.createStringLiteral(_localctx.IDENTIFIER, false);
				setState(183);
				_errHandler.sync(this);
	...
	public static class Member_expressionContext extends ParserRuleContext {
		public LamaExpressionNode r;
		public LamaExpressionNode assignmentReceiver;
		public LamaExpressionNode assignmentName;
		public LamaExpressionNode result;
		public ExpressionContext expression;
		public Token e;
		public Token IDENTIFIER;
		...
		public Member_expressionContext(ParserRuleContext parent, int invokingState, LamaExpressionNode r, LamaExpressionNode assignmentReceiver, LamaExpressionNode assignmentName) {
			super(parent, invokingState);
			this.r = r;
	...
	public final Member_expressionContext member_expression(LamaExpressionNode r, LamaExpressionNode assignmentReceiver, LamaExpressionNode assignmentName) throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			 LamaExpressionNode receiver = r;
			                                                  LamaExpressionNode nestedAssignmentName = null;
			setState(228);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
			case T__1:
